...
current_state = State() # Asignamos el valor de "State" a la variable "current_state"
goal_pose = PoseStamped()
goal_pose.pose.position.z = 2 # Establecemos la altura que el dron se desplazara cuando despege.
...
if __name__ == "__main__":
	...
	#Rate must be much higher than 2hz to avoid timeout
	rate = rospy.Rate(20)
	...
	rospy.loginfo('Publishing initial waypoints') # 'Publicando puntos de referencia'

	# Setpoints need to be streaming before commanding a switch to OFFBOARD mode.
	# Estableciendo los puntos necesarios antes de transmitir el cambio de modo de vuelo
	for i in range(50):
    ...
    # Aqui armamos el vehiculo para que este listo par despegar
