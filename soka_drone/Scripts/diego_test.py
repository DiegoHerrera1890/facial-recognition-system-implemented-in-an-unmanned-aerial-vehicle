...
class mavros_main_control():
    def __init__(self):
        ...
        self.takingoff_service = rospy.ServiceProxy(mavros.get_topic('cmd', 'takeoff'), CommandTOL)
        self.set_mode_service = rospy.ServiceProxy(mavros.get_topic('set_mode'), SetMode)
