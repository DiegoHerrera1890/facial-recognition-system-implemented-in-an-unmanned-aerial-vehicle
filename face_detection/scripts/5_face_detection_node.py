...
face_cascade = cv2.CascadeClassifier('/home/diego/facial-recognition-system-implemented-in-an-unmanned-aerial-vehicle/face_detection/scripts/haarcascade_frontalface_default.xml')
cap = cv2.VideoCapture(0) 
frame_width = 1280 #int(cap.get(3))
frame_height = 720 #int(cap.get(4))
fourcc = cv2.VideoWriter_fourcc(*'MJPG')
                            # /media/jetson/B2E4-69EA1/videos
video_out = cv2.VideoWriter('/home/diego/Videos/face_detection_11_15.avi', fourcc, 15, (frame_width,frame_height))
